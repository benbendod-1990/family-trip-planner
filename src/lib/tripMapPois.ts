...
const PLACE_ALIASES: Array<{ test: RegExp; key: string }> = [
  ...
  { test: /epcot/i, key: 'epcot, walt disney world' },
  { test: /disney\s*springs/i, key: 'disney springs, walt disney world' },
  { test: /seaworld/i, key: 'seaworld orlando' },
  { test: /peppa/i, key: 'peppa pig theme park, florida' },
  { test: /gatorland/i, key: 'gatorland, orlando' },
